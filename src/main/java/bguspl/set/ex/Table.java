...
public class Table {
    ...
    protected boolean[][] playersToken;
    ...
    public Table(Env env) {
        ...
        playersToken = new boolean[env.config.tableSize][env.config.players];
    ...
    public boolean removeToken(int player, int slot) {
        playersToken[slot][player] = false;
